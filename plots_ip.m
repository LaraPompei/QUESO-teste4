...
ylabel('\theta=a','fontname', 'Times', 'fontsize',20);
xlabel('chain position','fontname', 'Times', 'fontsize',20);
title('DRAM MCMC Chain Positions (raw)','fontname', 'Times', 'fontsize',20);
set(gca,'FontSize',16);
print -dpng sip_chain_pos_raw.png
pause;
clf;
...
ylabel('Autocorrelation for \theta=a','fontname', 'Times', 'fontsize',20);
...
set(gca,'FontSize',16);
print -dpng outputData/sip_autocorrelation_raw_filt.png
pause;
clf;
...
cov_matrix_a = cov(ip_mh_rawChain_unified)
